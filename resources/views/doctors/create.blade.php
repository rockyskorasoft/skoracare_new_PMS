            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="{{ route('admin.doctors.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="max_clinics" id="max_clinics" class="form-control @error('max_clinics') is-invalid @enderror" value="{{ old('max_clinics') }}" placeholder="-1 for Unlimited">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="max_users" id="max_users" class="form-control @error('max_users') is-invalid @enderror" value="{{ old('max_users') }}" placeholder="-1 for Unlimited">
                        <small class="text-muted">Editable limit</small>
                        @error('max_users')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                        @enderror
